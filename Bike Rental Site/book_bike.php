	...
	<section class="listings">
		<div class="wrapper">
			...
			?>
				...
				<h3>Proceed to Hire <?php echo $rws['bike_name'];?>. </h3>
				<?php
				...
				<?php
						if(isset($_POST['save'])){
							...
							$qry = "INSERT INTO client (fname,id_no,gender,email,phone,location,bike_id,status)
