				...
				<div class="box">
					...
					<?php
							if(isset($_POST['send'])){
								...
								$qr = "INSERT INTO bikes (image, bike_name,bike_type,hire_cost,capacity,status) 
...
<div id="sidebar">
				...
				<div class="box">
					...
					<div class="box-content">
						<a href="add_vehicles.php" class="add-button"><span>View Our Bikes</span></a>
						<div class="cl">&nbsp;</div>
...
<div id="footer">
	<div class="shell">
		...
		<span class="right">
			Design by <a href="http://projectworlds.in">BIKEHUB</a>
		</span>
	</div>
</div>
