					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<?php
								...
								$select = "SELECT client.client_id,client.fname,client.phone,bikes.bike_name,bikes.hire_cost,client.status 
										FROM client JOIN bikes ON client.bike_id=bikes.bike_id";
