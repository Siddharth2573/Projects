		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					...
					<div class="table" class="wow bounceInLeft"/>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td><a href="javascript:sureToApprove(<?php echo $row['bike_id'];?>)" class="ico del">Delete</a><a href="#" class="ico edit">Edit</a></td>
							</tr>
							<?php
								}
							?>
						...
						<div class="pagging">
							...
							<div class="right">								<a href="#">Previous</a>
								<a href="#">1</a>
								<a href="#">2</a>
								<a href="#">3</a>
								<a href="#">4</a>
			...
			<div id="sidebar">
				...
				<div class="box">
					...
					<div class="box-content">
						...
						<!-- Sort -->
						<div class="sort bounce animated">
							<label>Sort by</label>
							<select class="field">
